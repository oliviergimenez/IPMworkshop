...
{
  for (j in 1:ny){
    # 1 seen and ascertained Non-Breeder (with probability .2)
    # 2 seen and ascertained Breeder (with probability .7)
    # 3 seen but not ascertained (Non-Breeders with probability .8 + Breeders with probability .3)
    # 0 not seen
    
    # Non-Breeders are ascertained with probability .2
    if (titi[i,j] == 1)
    {
    ...
    # Breeders are ascertained with probability .7 (event = 1), 
